%{
    ...
    job_param_id                 :   char(3)          # Unique job ID
    ---
    ...
    nchannels_red                :   int              # How many channels did the red block have in total (assumes red is last)
    ...
    imagerate                    :   float            # Imaging rate (cumulative over planes!). Approximate, for initialization of deconvolution kernel.
