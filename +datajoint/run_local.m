function [ output_args ] = run_local( tif_path )

    disp(tif_path);
    %%%%%%%%%%%%%%%  RUN SUITE2P without DATAJOINT %%%%%%%%%%%%%%%%%%%%%%%%%%%
    %tif_path = 'L:\Flavio\2P\L8M1\12072018\MUnit_0';
    %tif_path = 'D:\scanimage\80412\28082018';
    diameter = 13; % ADJUST THIS!

    ops0.useGPU = 1;
    % TEMP TIF LOCATION
    db.temp_tiff = 'D:\TEMP\temp.tif';

    %%%%%%%%%%%%%%%%%%%% PATHS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    toolbox_path = 'C:\CODE\Suite2PKavli';
    oasis_path = 'C:\CODE\Suite2PKavli\OASIS_matlab';
